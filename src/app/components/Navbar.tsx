...
//prettier-ignore
import { AppBar, Box, IconButton, Link, Menu, MenuItem, Toolbar, Typography, useMediaQuery } from "@mui/material";
...
const Navbar = () => {
  ...
  if (showMobileBar) {
    return <AppBar position="static"></AppBar>; // PLACEHOLDER FOR THE MOBILE APP BAR
  }
